...
public class ModEntitySpawns {
    public static void addSpawns() {
        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.BAMBOO_JUNGLE),
                SpawnGroup.CREATURE, ModEntities.REDPANDA, 40, 1, 5);
        SpawnRestriction.register(ModEntities.REDPANDA, SpawnRestriction.Location.ON_GROUND,
                Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::isValidNaturalSpawn);



        BiomeModifications.addSpawn(BiomeSelectors.includeByKey(BiomeKeys.SWAMP, BiomeKeys.RIVER),
                SpawnGroup.CREATURE, ModEntities.CAPYBARA, 40, 1, 5);
