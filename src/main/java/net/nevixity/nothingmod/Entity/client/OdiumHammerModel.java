...
public class OdiumHammerModel extends EntityModel<Entity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData bone = modelPartData.addChild("bone", ModelPartBuilder.create().uv(16, 49).cuboid(-13.5F, -21.5F, 7.0F, 11.0F, 7.0F, 6.0F, new Dilation(0.0F))
                .uv(30, 34).cuboid(-9.0F, -17.5F, 9.0F, 2.0F, 12.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(8.0F, 24.0F, -8.0F));
